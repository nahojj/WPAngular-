...
angular.module('wpangularApp.main', [])
  .controller('mainCtrl', ['$scope', '$http', 'api', function ($scope, $http, api) {
    ...
    */
    ...
    // Get pages
    api.getPages(4).then(function(res) {
      $scope.startPage  = res;
      // console.log(res);
      $scope.startPageAcf    = res.acf.list_repeater;
      $scope.acfStarted      = res.acf.get_started_repeater;
      console.log($scope.startPageAcf);

    });

    // Get categoris with ID 3
    api.getCat(3).then(function(res) {
      $scope.cats = res;
    });

    // Set Hero Image height after screen height
    function setDimensions() {
      var windowsHeight = $(window).height();
      $('.hero').css('height', windowsHeight + 'px');
    }
